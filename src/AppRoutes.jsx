...
// Every path below is relative to /app — the parent route in App.jsx
// mounts this whole tree at /app/*.
        ...
        <Routes>
          ...
          <Route element={<GuestGate />}>
            <Route element={<AppLayout />}>
              ...
              <Route path="format" element={<Navigate to="/app/tonight" replace />} />
              <Route path="info" element={<Navigate to="/app/tonight" replace />} />
              ...
              {/* Any unknown path just falls back to the app home */}
